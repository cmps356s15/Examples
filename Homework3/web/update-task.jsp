...
<html>
    ...
    <body>
        ...
        <section>
            <h2>Update Task</h2>
            <form method="post" action="updatetask" id="updateForm"> 
                ...
                <div class="range-selector">
                    ...
                    <span id="fromMaxAya">${task.surah.ayaCount}</span>
                </div>
                ...
                <div class="range-selector">
                    ...
                    <span id="toMaxAya">${task.surah.ayaCount}</span>
                </div>
                <br>
                ...
                <input id="dueDate" name="dueDate" type="date" value="${dueDate}" required/>
